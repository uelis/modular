...
@from_space_mem = internal global [1048576 x i8] zeroinitializer, align 16
@from_space = global i8* getelementptr inbounds ([1048576 x i8]* @from_space_mem, i32 0, i32 0), align 8
@to_space_mem = internal global [1048576 x i8] zeroinitializer, align 16
@to_space = global i8* getelementptr inbounds ([1048576 x i8]* @to_space_mem, i32 0, i32 0), align 8
@next_free = global i32 0, align 4
@stderr = external global %struct._IO_FILE*
@.str = private unnamed_addr constant [15 x i8] c"out of memory\0A\00", align 1
@.str1 = private unnamed_addr constant [42 x i8] c"root != ((void*)0) && in_from_space(root)\00", align 1
@.str2 = private unnamed_addr constant [9 x i8] c"src/gc.c\00", align 1
@__PRETTY_FUNCTION__.gc_collect = private unnamed_addr constant [38 x i8] c"void gc_collect(size_t, int64_t, ...)\00", align 1
@.str3 = private unnamed_addr constant [22 x i8] c"in_from_space(record)\00", align 1
@__PRETTY_FUNCTION__.copy_record = private unnamed_addr constant [33 x i8] c"void copy_record(void *, void *)\00", align 1
@.str4 = private unnamed_addr constant [18 x i8] c"in_to_space(next)\00", align 1

; Function Attrs: nounwind uwtable
define void @raise_out_of_memory() #0 {
  %1 = load %struct._IO_FILE** @stderr, align 8
  %2 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([15 x i8]* @.str, i32 0, i32 0))
...
define i8* @gc_alloc(i64 %size) #3 {
  ...
  %2 = load i8** @from_space, align 8
  %3 = load i32* @next_free, align 4
  %4 = sext i32 %3 to i64
  %5 = getelementptr inbounds i8* %2, i64 %4
  store i8* %5, i8** %chunk, align 8
  %6 = load i64* %1, align 8
  %7 = load i32* @next_free, align 4
  %8 = sext i32 %7 to i64
  %9 = add i64 %8, %6
  %10 = trunc i64 %9 to i32
  store i32 %10, i32* @next_free, align 4
  %11 = load i32* @next_free, align 4
  %12 = icmp sge i32 %11, 1048576
...
define void @gc_collect(i64 %bytes_needed, i64 %rootc, ...) #0 {
  ...
  %3 = load i8** @to_space, align 8
  store i8* %3, i8** %next, align 8
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag]* %roots, i32 0, i32 0
...
; <label>:11                                      ; preds = %6
  %12 = getelementptr inbounds [1 x %struct.__va_list_tag]* %roots, i32 0, i32 0
...
; <label>:27                                      ; preds = %22, %16
  ...
  %30 = load i8** %root, align 8
  %31 = icmp ne i8* %30, null
  br i1 %31, label %32, label %36

; <label>:32                                      ; preds = %27
  %33 = load i8** %root, align 8
...
; <label>:36                                      ; preds = %32, %27
  call void @__assert_fail(i8* getelementptr inbounds ([42 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str2, i32 0, i32 0), i32 111, i8* getelementptr inbounds ([38 x i8]* @__PRETTY_FUNCTION__.gc_collect, i32 0, i32 0)) #6
  unreachable
                                                  ; No predecessors!
  br label %38

; <label>:38                                      ; preds = %37, %35
  %39 = load i8** %root, align 8
  %40 = bitcast i8* %39 to i64*
  %41 = load i64* %40, align 8
  %42 = ashr i64 %41, 32
  %43 = trunc i64 %42 to i32
  store i32 %43, i32* %size, align 4
  %44 = load i8** %root, align 8
  %45 = load i8** %next, align 8
  call void @copy_record(i8* %44, i8* %45)
  %46 = load i32* %size, align 4
  %47 = load i8** %next, align 8
...
; <label>:73                                      ; preds = %128, %61
  ...
  %75 = load i32* %ptr_count, align 4
  %76 = icmp slt i32 %74, %75
  br i1 %76, label %77, label %131

; <label>:77                                      ; preds = %73
  %78 = load i8** %scan, align 8
  %79 = bitcast i8* %78 to i64*
  %80 = getelementptr inbounds i64* %79, i64 1
  %81 = bitcast i64* %80 to i8**
  %82 = load i32* %i2, align 4
  %83 = sext i32 %82 to i64
  %84 = getelementptr inbounds i8** %81, i64 %83
...
; <label>:97                                      ; preds = %91
  ...
  %103 = load i8** %next, align 8
  %104 = load i32* %p_size, align 4
  %105 = sext i32 %104 to i64
  %106 = getelementptr inbounds i8* %103, i64 %105
...
; <label>:109                                     ; preds = %108, %97
  ...
  %111 = load i8** %next, align 8
  call void @copy_record(i8* %110, i8* %111)
  %112 = load i32* %p_size, align 4
  %113 = load i8** %next, align 8
...
; <label>:131                                     ; preds = %73
  %132 = load i32* %size1, align 4
  %133 = load i8** %scan, align 8
  %134 = sext i32 %132 to i64
  %135 = getelementptr inbounds i8* %133, i64 %134
  store i8* %135, i8** %scan, align 8
  br label %57

; <label>:136                                     ; preds = %57
  %137 = load i8** %next, align 8
  %138 = load i8** @to_space, align 8
  ...
  %144 = load i32* @next_free, align 4
  %145 = sub nsw i32 1048576, %144
...
; <label>:149                                     ; preds = %148, %136
  %150 = load i8** @from_space, align 8
  store i8* %150, i8** %tmp, align 8
  %151 = load i8** @to_space, align 8
  store i8* %151, i8** @from_space, align 8
  %152 = load i8** %tmp, align 8
...
; <label>:5                                       ; preds = %0
  %6 = load i8** %1, align 8
  %7 = load i8** @from_space, align 8
  %8 = getelementptr inbounds i8* %7, i64 1048576
  %9 = icmp ult i8* %6, %8
  br label %10
...
; <label>:6                                       ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([22 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str2, i32 0, i32 0), i32 83, i8* getelementptr inbounds ([33 x i8]* @__PRETTY_FUNCTION__.copy_record, i32 0, i32 0)) #6
  unreachable
                                                  ; No predecessors!
  br label %8
...
; <label>:12                                      ; preds = %8
  call void @__assert_fail(i8* getelementptr inbounds ([18 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str2, i32 0, i32 0), i32 84, i8* getelementptr inbounds ([33 x i8]* @__PRETTY_FUNCTION__.copy_record, i32 0, i32 0)) #6
  unreachable
                                                  ; No predecessors!
  br label %14
